...
from utils.dice_loss import Intersection_over_Union_isic, val_jaccard_isic, jaccard_isic, jaccard_coef
from time import *
import warnings
...
def test_isic(test_loader, model):
    ...
    for step, (img, lab) in enumerate(test_loader):
        ...
        # SKY
        isic_b_jaccard = jaccard_coef(target_soft, output_soft)
        jaccard_np = isic_b_jaccard.data.cpu().numpy()
        isic_jaccard.append(jaccard_np)
